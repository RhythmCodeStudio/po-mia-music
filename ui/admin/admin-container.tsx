...
export default function AdminContainer({
  ...
  return (
   <section className="bg-black/50 rounded-4xl shadow-lg shadow-white border-2 border-[rgba(255,255,255,0.3)] w-full max-w-6xl min-w-[16rem] flex flex-col items-center p-6 pb-12">
      <Heading
        headingLevel={2}
