  ...
  return (
    <>
      {renderedAs === "icon" ? (
        ...
        <button
          onClick={subscribeToPush}
          className="cursor-pointer border-2 border-border-default p-1 px-4 rounded-full shadow rainbow-gradient text-shadow-black-background-black w-full shadow-white shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#174054] transform transition-transform transition-shadow duration-200 active:scale-95">
