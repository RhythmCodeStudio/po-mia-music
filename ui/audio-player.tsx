...
export default function SimpleAudioPlayer({ song }: { song: Song }) {
  ...
  return (
    <div className="px-6 flex flex-col items-center gap-4 w-full max-w-lg mx-auto p-2 rounded-4xl shadow-lg rainbow-gradient shadow-black border-2 border-border-default relative">
