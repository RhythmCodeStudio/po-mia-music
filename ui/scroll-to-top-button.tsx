  ...
  return (
    <div className="flex ml-auto z-50 text-outline">
      <button
        ...
        className={`cursor-pointer z-80 shadow-lg shadow-white border-border-default rainbow-gradient text-black fixed bottom-4 right-4 8xl:right-8 rounded-full p-2 w-12 hover:transform hover:scale-110 transition-all duration-700 ease-in-out ${
