...
export default function ContactFormContainer() {
  ...
  return (
    <div className="flex flex-col items-stretch sm:text-lg xl:text-xl 2xl:text-2xl w-full max-w-2xl p-4 lg:p-8 bg-black/50 border-border-default border-2 shadow-white shadow-lg rounded-4xl">
      {formSubmitted ? (
        <div className="items-center justify-center ">
          <h2 className="text-4xl text-center">thank you!</h2>
          <p className="m-8 text-center text-balance">thank you!</p>
