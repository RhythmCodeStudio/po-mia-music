...
export default async function CalendarEventPage({
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full">
      ...
      <p className="text-shadow-black-background-black text-3xl font-semibold ">
        {event.location_name}
      </p>
      <GoogleMapsLink
        ...
        className="text-shadow-black-background-black underline decoration-blue-600 hover:decoration-blue-800 text-xl"
      />
