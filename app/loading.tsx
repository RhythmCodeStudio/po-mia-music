...
export default function HomePageLoadingSkeleton() {
  return (
    <div className="relative flex flex-col flex-grow items-center justify-center pt-8 w-full px-2">
      ...
      {/* Bio skeleton */}
      <div className="bg-black/50 m-6 lg:mx-auto py-4 rounded-4xl shadow-lg shadow-black/20 max-w-4xl border-2 border-gray-300/30 w-full">
        <SkeletonBox className="h-6 w-40 sm:h-8 sm:w-64 mb-4 mx-auto" />
        <div className="flex flex-col gap-2 px-6 w-full max-w-2xl mx-auto">
          {[...Array(4)].map((_, i) => (
