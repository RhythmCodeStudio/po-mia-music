    ...
    <div className="relative flex flex-col flex-grow items-center justify-center space-y-12 ">
      ...
      <div className="flex flex-col items-center w-full max-w-2xl mx-auto px-6 lg:px-0">
        <Image
          ...
          height={1902}
          priority
          className="rounded-4xl shadow-white shadow-lg z-10"
          style={{ border: "2px solid rgba(255, 255, 255, 0.3)" }}
        />
      </div>
      <div className="bg-neutral-200/50 mt-6 py-4 rounded-4xl shadow-lg shadow-black/20 max-w-2xl mx-6 lg:mx-auto border-2 border-[rgba(255,255,255,0.3)]">
